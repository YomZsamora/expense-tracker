...
const { logoutController } = require('../../app/controllers/user-controllers.js');

const TEST_USER_ID = '00000000-0000-0000-0000-000000000099';
const TEST_EMAIL = 'logouttest@test.local';
const TEST_PASSWORD = 'TestLogout@1';

describe('Logout API - POST /v1/users/logout', () => {
    let logoutUser;
    ...
    describe('Authentication', () => {
        it('should return 401 when no Authorization header is provided', async () => {
            const res = await request(app).post('/v1/users/logout');
